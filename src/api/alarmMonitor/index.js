...
const baseUrl = '/alarm';
const axios = instance('http://127.0.0.1:8001'); // 可替换的路径,比如后端开发的本地接口数据

// const axios = instance(); // 默认的接口数据

const apiData = params => axios.get(`${baseUrl}/mockList`, {params}).then(res => res);
